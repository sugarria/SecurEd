...
public class Quiz3 extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.next_button:
		    ...
		    if(totalPoint.getVisit3() == 0){
		    	totalPoint.setVisit3(1);
	...
	public void finish_quiz(){
		Intent intent = new Intent(this, Quiz3Explanation.class);
