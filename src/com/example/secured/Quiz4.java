...
public class Quiz4 extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.next_button:
		    ...
		    if(totalPoint.getVisit4() == 0){
		    	totalPoint.setVisit4(1);
	...
	public void finish_quiz(){
		Intent intent = new Intent(this, Quiz4Explanation.class);
